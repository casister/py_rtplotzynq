...
class Logger:
    ...
    def __init__(self, level, enable_console=False):
        ...
        FileManager.create_dir(PlotConstants.app_export_path)
        file_handler = logging.handlers.RotatingFileHandler("{}/{}"
                                                            .format(PlotConstants.app_export_path,
                                                                    PlotConstants.log_filename),
                                                            maxBytes=PlotConstants.log_max_bytes,
                                                            backupCount=0)
