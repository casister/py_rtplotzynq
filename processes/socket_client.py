...
from constants.constants import plot_constants
...
class SocketProcess(multiprocessing.Process):
    ...
    def run(self):
        ...
        while not self._exit.is_set():
            ...
            try:
                data = self._socket_client.recv(plot_constants.SocketClient.buffer_recv_size).decode()
                if len(data) > 0:
    ...
    def get_default_host():
        ...
        if hostip is not None:
            return [plot_constants.SocketClient.host_default, hostname, hostip]
        else:
            return [plot_constants.SocketClient.host_default, hostname]
    ...
    def get_default_port():
        ...
        :return: str list.
        """
        return [str(v) for v in plot_constants.SocketClient.port_default]
